...
<body>
    ...
    <div class="container my-5" id="center">
        <h3>Completa los siguientes campos para añadir un nuevo usuario:</h3>
        <form action="aniadir-1.php" method="POST" enctype="multipart/form-data">
            <label for="modelo">DNI:</label><br>
            <input type="text" name="dni" class="form-control mb-2"><br>
            <label for="modelo">Nombre:</label><br>
            <input type="text" name="nombre" class="form-control mb-2"><br>
            <label for="modelo">Apellidos:</label><br>
            <input type="text" name="apellidos" class="form-control mb-2"><br>
            <label for="modelo">Contraseña:</label><br>
            <input type="password" name="contrasenia" class="form-control mb-2"><br>
            <label for="modelo">Saldo:</label><br>
            <input type="text" name="saldo" class="form-control mb-2"><br>
