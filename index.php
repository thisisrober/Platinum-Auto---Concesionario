...
<body>
    ...
    <div class="container my-5" id="center">
        ...
        <button onclick="location.href='coches/index.php'">Coches</button><br>
        <?php if (isset($_SESSION['usuario_id']) && $_SESSION['tipo_usuario'] == 'admin'): ?>
            <button onclick="location.href='usuarios/index.php'">Usuarios</button><br>
            <button onclick="location.href='alquileres/index.php'">Alquileres</button>
        <?php endif; ?>
    </div>
